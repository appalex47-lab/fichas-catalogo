...
Abre `index.html` en el navegador, o publícala con GitHub Pages (Settings, Pages, rama `main`, carpeta raíz). Para que funcione, `index.html`, `styles.css`, `logic.js` y `app.js` deben estar en la misma carpeta.
...
| `tests/logic.test.js` | 13 pruebas automáticas de `logic.js`. No las usa la página |
...
La página solo necesita `index.html`, `styles.css`, `logic.js` y `app.js`. Los demás archivos sirven para documentar, proteger y mantener el código.
