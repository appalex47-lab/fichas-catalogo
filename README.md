...
1. En "Exportar a Magento" elige la codificación del archivo.
2. Descarga el CSV.
3. Pruébalo primero con 2 o 3 SKU en un ambiente de pruebas.

### Modo de ayuda

Arriba a la derecha eliges cuánta ayuda ves. Es el mismo selector de la herramienta de diagnóstico de ventas.

- 🟢 **Guía:** abre todas las explicaciones («?»).
- 🟡 **Ayuda:** las deja plegadas. Es el modo por defecto.
- 🔵 **Copiloto:** activa la IA (Cohere): completar datos crudos y el asistente de uso.

### IA con Cohere (opcional, modo Copiloto)

La herramienta funciona completa sin IA. En modo Copiloto agrega tres cosas:
...
- Marca, laboratorio y principio activo solo si están en tus diccionarios (Ajustes). El botón "Agregar al diccionario los valores del lote" los aprende del trabajo ya hecho.
...
Las categorías, campos y plantillas están en `CATS`, dentro de `logic.js`. Las estructuras de meta y de alt se editan desde la interfaz (Exportar a Magento, Estructura de meta etiquetas y alt).
